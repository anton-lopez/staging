...
class DormListView(ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        for dorm in context['dorms']:
            dorm.labels_list = dorm.labels.split(',') if dorm.labels else []  # Preprocess labels
        return context
...
class DormDetailView(DetailView):
    ...
    def get_context_data(self, **kwargs):
        ...
        dorm = self.object
        context['labels_list'] = dorm.labels.split(',') if dorm.labels else []
...
class DormCreateView(LoginRequiredMixin, CreateView):
    ...
    def form_valid(self, form):
        # Process the labels field
        labels = form.cleaned_data.get('labels', '')
        form.instance.labels = labels  # Save the cleaned labels to the instance
